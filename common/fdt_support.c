...
#include "generated/timestamp_autogenerated.h" // 包含 U_BOOT_VERSION
#include "generated/version_autogenerated.h"   // 包含 U_BOOT_BUILD_DATE 和 U_BOOT_BUILD_TIME
/**
...
int fdt_chosen(void *fdt)
{
    ...
    // 添加 U-Boot 版本号
    fdt_setprop_string(fdt, nodeoffset, "u-boot-version", U_BOOT_VERSION);
    // 合并编译日期和时间
